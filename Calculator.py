...
def sinh_clicked():
        try:
            ans = float(disp.get())
            if switch is True:
                ans = math.sinh(math.radians(ans))
            else:
                ans = math.sinh(ans)
            disp.delete(0, END)
            disp.insert(0, str(ans))
...
def cosh_clicked():
        try:
            ans = float(disp.get())
            if switch is True:
                ans = math.cosh(math.radians(ans))
            else:
                ans = math.cosh(ans)
            disp.delete(0, END)
            disp.insert(0, str(ans))
...
disp = Entry(root, font="Verdana 20", fg="black", bg="white", bd=0, justify=RIGHT, insertbackground="white",
                 cursor="arrow")
...
"""
btnrecp = Button(btnrow1, text="rectang\nperi", font="Segoe 14", relief=GROOVE,command=rect_peri,
         bd=0, fg="white",bg="#333333").grid(row=1, column=2, pady=1)
"""
btnrow1 = Frame(root, bg="#000000")
btnrow1.pack(expand=TRUE, fill=BOTH)

sinh_btn = Button(btnrow1, text="sinh", font="Segoe 18", relief=GROOVE, bd=0, command=sinh_clicked, fg="white",
                 bg="#333333")
...
cosh_btn = Button(btnrow2, text="cosh", font="Segoe 18", relief=GROOVE,command=cosh_clicked, bd=0, fg="white",bg="#333333")
...
tanh_btn = Button(btnrow3, text="tanh", font="Segoe 18", relief=GROOVE,command=tanh_clicked, bd=0, fg="white",bg="#333333")
tanh_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)
...
ln_btn = Button(btnrow3, text="ln", font="Segoe 18", relief=GROOVE, bd=0, command=ln_clicked, fg="white",
                    bg="#333333")
...
btnml = Button(btnrow3, text="*", font="Segoe 23", relief=GROOVE, bd=0, command=btnml_clicked, fg="white",
                   bg="#333333")
...
"""
btnreca = Button(btnrow4, text="rectang\narea", font="Segoe 14", relief=GROOVE,command=rect_area, bd=0, fg="white",bg="#333333")
btnreca.pack(side=LEFT, expand=TRUE, fill=BOTH)

btna = Button(btnrow4, text="square\narea", font="Segoe 14", relief=GROOVE,command=sqr_area, bd=0, fg="white",bg="#333333")
btna.pack(side=LEFT, expand=TRUE, fill=BOTH)
"""
mod_btn = Button(btnrow4, text="%", font="Segoe 21", relief=GROOVE, bd=0, command=mod_clicked, fg="white",
                     bg="#333333")
mod_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

bl_btn = Button(btnrow4, text=" ( ", font="Segoe 21", relief=GROOVE, bd=0, command=bl_clicked, fg="white",
                    bg="#333333")
bl_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

br_btn = Button(btnrow4, text=" ) ", font="Segoe 21", relief=GROOVE, bd=0, command=br_clicked, fg="white",
                    bg="#333333")
...
del_btn = Button(btnrow4, text="⋘", font="Segoe 20", relief=GROOVE, bd=0, command=del_clicked, fg="white",
                     bg="#333333")
...
btneq = Button(btnrow4, text="=", font="Segoe 23", relief=GROOVE, bd=0, command=btneq_clicked, fg="white",
                   bg="#333333")
